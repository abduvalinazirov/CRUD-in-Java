...
public class SwaggerConfigure extends WebMvcConfigurationSupport {
  ...
  public Docket productApi() {
    return new Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.example.students.controller"))
        .paths(regex("/.*"))
        .build()
        .apiInfo(metaData());
  }
...
//        .license("Apache License Version 2.0").licenseUrl("https://www.apache.org/licenses/LICENSE-2.0")
        .contact(new Contact("Nazirov Abduvali", "http://localhost:8084/", "abduvali.nazirov.0@gmail.com")).build();
    return apiInfo;
  }
